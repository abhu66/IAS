 ...
 * @author asyst
 */
public class FormEditAsset extends javax.swing.JDialog {
     ...
     */
    public FormEditAsset(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     public void initView(String code){
        ...
        jComboBox1.setSelectedItem(asset.condition);
        jDateChooser1.setDate(asset.createdDate);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Asset asset = new Asset(id,code, name, deskripsi, condition, createdDate,"AVAILABLE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditAsset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormEditAsset dialog = new FormEditAsset(new javax.swing.JFrame(), true);
