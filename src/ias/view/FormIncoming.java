 ...
 * @author asyst
 */
public class FormIncoming extends javax.swing.JDialog {
    ...
    public FormIncoming(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//tableTransactionIncoming();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormIncoming.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormIncoming dialog = new FormIncoming(new javax.swing.JFrame(), true);
